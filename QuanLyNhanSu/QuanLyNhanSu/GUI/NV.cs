...
namespace QuanLyNhanSu.GUI
{
    public partial class NV : UserControl
    {
        ...
        {
            DialogResult Form = MessageBox.Show("Bạn có muốn thoát không?", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
        ...
        {
            DialogResult Form = MessageBox.Show("Bạn có chắc muốn xóa!", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
            if (Form == DialogResult.OK)
            {
                ketnoi.openketnoi();
